...
(async () => {
  ...
  try {
    ...
    if (trayRecomputeExists) {
      await page.click("#manualTrayDock [data-manual-toolbar='recompute']");
    } else {
      await page.click("#inventoryManualRecomputeBtn");
    }
    ...
    if (trayApplyExists) {
      await page.click("#manualTrayDock [data-manual-toolbar='apply']");
    } else {
      await page.click("#inventoryStep2ApplyBtn");
    }
